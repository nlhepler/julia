...
#if LLVM33
    AttributeSet set = Attributes::get(AttributeSet::ReturnIndex,retattrs);
    for(i = 1; i < nargs+1; ++i)
        set = set.addAttributes()
    ((CallInst*)ret)->setAttributes
    //TODO: Fixme (need to find global LLVMContext)
#elif LLVM32
